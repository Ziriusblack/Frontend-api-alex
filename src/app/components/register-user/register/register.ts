...
export class Register {
  ...
  registerUser() {
    ...
    this.authService.register(registerRequest).subscribe({
      ...
      error: (error) => {        
        this.errorMessage = 'Parace que hubo un error, intente nuevamente en un momento.';
      }
    });
  }

  // ✅ Nuevo método para regresar al home
  goHome() {
    this.router.navigate(['/']); // Ajusta la ruta si tu home no es "/"
  }
